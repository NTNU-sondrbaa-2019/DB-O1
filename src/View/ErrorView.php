<?php
/** The View of the IMT2571 Assignment #1 MVC-example that shows error
...
/** The class that creates a page showing error information when the system
  * fails in processing the request.
  * @author Rune Hjelsvold
...
class ErrorView extends View
{
    ...
    /**
      * @param string $msg The message to pass to the user if set; a standard
      * message will be
      *               passed otherwise.
      */
